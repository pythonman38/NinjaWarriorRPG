...
public class PlayerCatchSwordState : PlayerState
{
    ...
    public override void Enter()
    {
        ...
        if (player.transform.position.x > sword.position.x && player.facingDirection == 1) player.Flip();
        else if (player.transform.position.x < sword.position.x && player.facingDirection == -1) player.Flip();
